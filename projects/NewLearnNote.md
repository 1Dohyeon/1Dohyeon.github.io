...
**배경:**
NewLearn Note에 통합될 AI 문서 분석 기능을 독립 프로젝트([Nura](https://github.com/newlearnnote/Nura-server/blob/main/README.md))로 먼저 개발하여 프로토타입을 검증했습니다.
...
**구현 상태:**
현재는 그래프 기반 추천이 구현되었고, AI 분석은 Nura 프로젝트에서 프로토타입으로 검증 중입니다.

**학습:**
추천 시스템은 속도와 정확성 사이의 trade-off를 고려해야 한다는 것을 배웠습니다. 그래프 기반과 AI 분석을 조합하는 하이브리드 접근으로 두 가지 목표를 모두 달성할 수 있다는 점을 설계하며 배웠습니다.
